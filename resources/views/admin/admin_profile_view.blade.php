...
<div class="box box-widget widget-user">
  ...
  <img class="rounded-circle" src="{{ (!empty($adminData->profile_photo_path))? url('storage/upload/admin_images/'.$adminData->profile_photo_path):url('storage/upload/no_image.jpg') }}" alt="User Avatar">
