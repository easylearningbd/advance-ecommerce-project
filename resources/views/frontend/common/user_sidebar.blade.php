...
<div class="col-md-2"><br>
				<img class="card-img-top" style="border-radius: 50%" src="{{ (!empty($user->profile_photo_path))? url('storage/upload/user_images/'.$user->profile_photo_path):url('storage/upload/no_image.jpg') }}" height="100%" width="100%"><br><br>
