            ...
            <div class="row">
              <div class="col-md-6 col-sm-4 col-lg-4">
                <div class="info-box">
                  <div class="row">
                    <div class="col-xs-12">
                      <h4 class="info-box-heading green">{{ trans('site.moneyback') }}</h4>
                    </div>
                  </div>
                  <h6 class="text">{{ trans('site.30daysmoneybackgarantee') }}</h6>
                </div>
              </div>
              <!-- .col -->
              ...
              <div class="hidden-md col-sm-4 col-lg-4">
                <div class="info-box">
                  <div class="row">
                    <div class="col-xs-12">
                      <h4 class="info-box-heading green">{{ trans('site.freeshipping') }}</h4>
                    </div>
                  </div>
                  <h6 class="text">{{ trans('site.shippingonordersover99') }}</h6>
                </div>
              </div>
              <!-- .col -->
              ...
              <div class="col-md-6 col-sm-4 col-lg-4">
                <div class="info-box">
                  <div class="row">
                    <div class="col-xs-12">
                      <h4 class="info-box-heading green">{{ trans('site.specialsale') }}</h4>
                    </div>
                  </div>
                  <h6 class="text">{{ trans('site.extraoffallitems') }}</h6>
                </div>
              </div>
              <!-- .col -->
            </div>
